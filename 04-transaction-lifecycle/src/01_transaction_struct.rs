...
impl Transaction {
    pub fn new(hash: [u8; 32], from: [u8; 20], to: Option<[u8; 20]>, value: u64, nonce: u64, gas_limit: u64, gas_price: u64) -> Self {
        Transaction { hash, from, to, value, nonce, gas_limit, gas_price }
    }
